          ...
          <div class="row">
            ...
            <div class="row mt-4" style="justify-content: right;">
              <div class="col-6" style="display: flex">
                ...
                <div class="col-6">
                  <button id="btn-white" @click="updateFinanceiro" class="btn w-100 px-3 mb-2 btn-outline-success" :disabled="isFormInvalid">
                    Salvar
                  </button>
                </div>
              </div>
...
<script>
import {editFinanceiro, getInfosFinanceiro} from "@/views/Financeiro/financeiro_service";
import {formatDate} from "@/utils";
export default {
  name: "edit_financeiroganho",
  components: {
    ...
    getAllInfosFinanceiro() {
      getInfosFinanceiro(this.ID)
          .then((response) => {
            ...
            this.forms[1].value = response.data.data.ganhos;
            this.forms[2].value = response.data.data.tipo_transacao;
